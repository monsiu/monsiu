...
- Just launched [**PesaShift**](https://monsiu.github.io/pesashift-android/): see every shilling M-PESA takes. An on-device statement analyser for Android that parses M-PESA and Airtel Money PDF statements entirely on the phone, breaking down fees, Fuliza costs, and hidden charges Airtel never itemises. The statement never leaves the device. Direct APK, Zapstore, and the Amazon Appstore today; Google Play and Huawei AppGallery in review.
